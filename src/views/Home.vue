<template>
  <b-container fluid="md" class="view--home">
    <b-row
      align-h="center"
      align-v="center"
    ...
    >
      <b-col cols="8" sm="6">
        <b-card bg-variant="transparent" no-body class="mt-4 pt-4 border-0">
          <b-img
            center
            rounded="circle"
    ...
    <b-card-body>
      ...
      <b-card-sub-title class="mb-4"
        >Account type: {{ usuarioDB.role }}</b-card-sub-title
      >
      <b-card-text>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores
        quibusdam odit, aperiam architecto perferendis quas vitae soluta quia
        non corrupti aut animi, repellat numquam, alias aliquam esse nisi
        tenetur ut.
      </b-card-text>
    </b-card-body>
    <div>
      <p class="home__date--member">
        Member since: {{ usuarioDB.date | moment("dddd, MMMM Do YYYY") }}
      </p>
    </div>
...
export default {
  ...
  methods: {
    ...
    uploadImage() {
      ...
      this.axios
        .put(`/upload/${this.usuarioDB._id}`, formData, {
